...
#' @param \code{from_fy} Financial year of \code{labour_force}. If both from_fy and to_fy are not given, the previous financial year is the default value for from_fy.  
#' @param \code{to_fy} Financial year for which the labour force is predicted. If both from_fy and to_fy are not given, the current financial year is the default value for to_fy.
...
lf_inflator_fy <- function(labour_force = 1, from_fy = NULL, to_fy = NULL, 
