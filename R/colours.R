...
delayedAssign("pal.7", c("black", col.6, col.5, col.4, col.3, col.2, col.1))
delayedAssign("pal.8", c("black", theGrey, col.6, col.5, col.4, col.3, col.2, col.1))
delayedAssign("pal.9", c("black", theGrey, col.6, col.5, col.4, col.3, col.2, col.1, "white"))