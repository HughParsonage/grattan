...
#' @param adjustment Should there be an adjustment made to the index? Adjustments include 'none' (no adjustment), 'seasonal', or 'trimmed mean'. By default, \code{seasonal}.
...
cpi_inflator_quarters <- function(from_nominal_price, from_qtr, to_qtr, adjustment = "seasonal",
