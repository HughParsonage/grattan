...
model_Budgets <- function(fy_year, 
  ...
  list(Budget2018_baseline = model_income_tax(),
       Budget2018_medicare25 = model_income_tax(medicare_levy_rate = 0.025),
       ...
       Budget2018 = model_income_tax(ordinary_tax_rates = ordinary_tax_rates(h),
                                     ...
                                     lito_202223 = h > 6,
                                     lamington = fy_year %in% c("2018-19", "2019-20", "2020-21", "2021-22")),
       Budget2018_Step1and2 = model_income_tax(ordinary_tax_rates = ordinary_tax_rates(pmin(h, 8)), 
                                               ordinary_tax_thresholds = ordinary_tax_thresholds(pmin(h, 8)),
                                               lito_202223 = h > 6, 
                                               lamington = fy_year %in% c("2018-19", "2019-20", "2020-21", "2021-22")),
