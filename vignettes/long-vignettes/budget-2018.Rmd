...
```{r s2728_Treasury}
if (file.exists("budget-2018_cache/s2728_Treasury.fst")) {
  s2728_Treasury <- read_fst("budget-2018_cache/s2728_Treasury.fst", 
                             as.data.table = TRUE)
} else {
  s2728_Treasury <- .project_useTreasurys[[2028L - 2016L]]
  write_fst(s2728_Treasury, "budget-2018_cache/s2728_Treasury.fst")
}
```
...
avgTaxRate50 <- function(id, fy) {
  ...
  avg_tax_rates_by_percentile_facet_fy[.(fy, id, 50L), avg_tax_rate]
}
```
...
s2728_various_wages <-
  if (file.exists(s2728_various_wages.fst <- "budget-2018_cache/s2728_various_wages.fst")) {
