...
account for `r texNumD(revenue_foregone(Budget_1922[["2027-28"]][["Budget2018_just_rates"]], FALSE))`
of the `r texNumD(revenue_foregone(Budget_1922[["2027-28"]][["Budget2018"]]))` in lower revenue.
...
ShareTaxPaid_by_Decile_id <- 
  list("2017-18" = select_grep(s1718, "^(new_)?tax$", .and = "Taxable_Income"),
       "2027-28 baseline" = Budget_1922[["2027-28"]][["Budget2018_baseline"]][, .(Taxable_Income, tax = new_tax)],
       "2027-28 budget" = Budget_1922[["2027-28"]][["Budget2018"]][, .(Taxable_Income, tax = new_tax)]
  ) %>%
...
ShareTaxPaid_by_Decile_id <- 
  list("2017-18" = s1718[, .(Taxable_Income, tax)],
       "2027-28 baseline" = Budget_1922_Grattan2.75[["2027-28"]][["Budget2018_baseline"]][, .(Taxable_Income, tax = new_tax)],
       "2027-28 budget" = Budget_1922_Grattan2.75[["2027-28"]][["Budget2018"]][, .(Taxable_Income, tax = new_tax)]
  ) %>%
  rbindlist(use.names = TRUE,
            fill = TRUE,
            idcol = "id") %>%
...
s2024_Deloitte_LF_growth <- 
  project(sample_file_1516, h = 9L, lf.series = 0.0135) %>%
