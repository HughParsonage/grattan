...
```{r loadPackages-3}
if (file.exists("~/taxstats1516/data-raw/sample_file_1516_synth.tsv")) {
  library(taxstats)
  sample_file_1516_synth <- fread("~/taxstats1516/data-raw/sample_file_1516_synth.tsv")
} else {
  ...
  sample_file_1516_synth <- 
    fread("https://github.com/HughParsonage/taxstats1516/raw/master/data-raw/sample_file_1516_synth.tsv") %>%
    .[, Ind := .I]
}
```
...
```{r load-grattan, eval=TRUE}
library(grattan)
```

# LITO

The effect of changing LITO:
